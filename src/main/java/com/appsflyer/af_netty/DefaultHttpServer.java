...
import com.appsflyer.af_netty.util.NativeEventLoop;
import com.appsflyer.af_netty.util.NativeEventLoopFactory;
...
public final class DefaultHttpServer implements HttpServer
{
  ...
  static HttpServer createHttpServer(ServerConfiguration config)
  {
